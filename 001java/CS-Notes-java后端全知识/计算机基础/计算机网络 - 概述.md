...
互联网服务提供商 ISP(网络服务提供商,Internet Service Provider) 可以从互联网管理机构获得许多 IP 地址，同时拥有通信线路以及路由器等联网设备，个人或机构向 ISP 缴纳一定的费用就可以接入互联网。
...
目前的互联网是一种多层次 ISP 结构，ISP 根据覆盖面积的大小分为第一层 ISP、区域 ISP 和接入 ISP。互联网交换点 IXP (Internet Exchange Points)允许两个 ISP 直接相连而不用经过第三个 ISP。也就是说ISP通过IXP彼此相连
...
## 计算机网络体系结构(也可参考https://zhuanlan.zhihu.com/p/33889997)
